...
public class PhotonGhostStage : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        ////////////////////////////////////////////////////////////
        ghostSpwanPoint = GameObject.FindWithTag("GhostSpawnPoint").transform;
    }
    IEnumerator Start()
    {
    ...
    void CreateGhost()
    {
        PhotonNetwork.Instantiate("Ghost",ghostSpwanPoint.position, ghostSpwanPoint.rotation, 0);
    }
}
